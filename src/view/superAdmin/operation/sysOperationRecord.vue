  ...
  <div>
    ...
    <div class="gva-table-box">
      ...
      >
        ...
        <el-table-column align="center" label="日期" width="180" type="date">
        ...
        <el-table-column align="center" label="请求路径" prop="path" width="400" />
        <el-table-column align="center" label="请求" prop="path" width="100">
          <template #default="scope">
            <div>
